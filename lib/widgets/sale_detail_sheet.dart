        ...
        children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: 48, child: Text('العدد', style: theme.textTheme.labelSmall?.copyWith(color: theme.colorScheme.outline))),
                              ...
                              SizedBox(
                                ...
                                child: _isEditing
                                  ...
                                  onChanged: (v) {
                                    ...
                                    : Center(child: Text(item.quantity.toString(), style: const TextStyle(fontSize: 14))),
                              ),
                              Expanded(
                                flex: 2,
                                child: Text(
          ...
          Row(
            ...
            children: [
              ...
              Text(
                '${_currentTotal.toStringAsFixed(2)} ر.س',
