  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
                      ...
                      child: ValueListenableBuilder<TorchState>(
                        ...
                        builder: (context, state, _) {
                          ...
                          return IconButton(
                            ...
                            onPressed: () => widget.scannerCtrl.toggleTorch(),
        ...
        Expanded(
          child: _CartArea(onComplete: _completeSale, isCompleting: _isCompletingSale, customerNameCtrl: _customerNameCtrl),
        ),
      ],
    );
  }
...
class _CartArea extends StatelessWidget {
  ...
  const _CartArea({required this.onComplete, required this.isCompleting, required this.customerNameCtrl});
