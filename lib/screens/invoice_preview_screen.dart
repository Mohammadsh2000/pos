        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              showTopNotification(context, 'تم حفظ الفاتورة بخط كبير في: $path', duration: const Duration(seconds: 5));
            },
          ),
          IconButton(
            ...
            onPressed: () {
              ...
              showTopNotification(context, 'تم نسخ الفاتورة - يمكنك لصقها في واتساب أو أي تطبيق آخر');
            },
          ),
          IconButton(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(flex: 2, child: Text(
                  item.isKg ? '${item.quantity.toStringAsFixed(2)} كجم' : '${item.quantity.toInt()}',
