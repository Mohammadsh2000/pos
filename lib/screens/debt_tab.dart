  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      SharedPreferences.getInstance().then((prefs) {
        setState(() => _showSummary = prefs.getBool('debt_show_summary') ?? true);
      });
    });
  ...
  Future<void> _exportDebts() async {
    ...
    try {
      ...
      try {
        ...
        if (!mounted) return;
        showSuccessNotification(context, 'تم تصدير الديون بنجاح');
      } finally {
          ...
          children: [
            ...
            _ActionBar(
              ...
              onToggleSummary: () {
                ...
                SharedPreferences.getInstance().then((prefs) => prefs.setBool('debt_show_summary', _showSummary));
              },
              theme: theme,
            ),
            Expanded(
            ...
            children: [
              ...
              Container(
                ...
                child: IconButton(
                  ...
                  icon: Icon(
                    showSummary ? Icons.visibility_outlined : Icons.visibility_off_outlined,
